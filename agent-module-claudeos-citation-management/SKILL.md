---
name: agent-module-citation-management
description: "Module: Comprehensive citation management for academic research. Search Google Scholar and PubMed for papers, extract accurate metadata, validate citations, and generate properly formatted BibTeX entries. This skill should be used when you need to find papers, verify citation information, convert DOIs to BibTeX, or ensure reference accuracy in scientific writing."
---
# Module: Citation Management

## 1. Module Metadata
- Module ID: `agent.module.citation-management`
- Version: `1.0.0`
- Maturity: `migrated`
- Scope: Comprehensive citation management for academic research. Search Google Scholar and PubMed for papers, extract accurate metadata, validate citations, and generate properly formatted BibTeX entries. This skill should be used when you need to find papers, verify citation information, convert DOIs to BibTeX, or ensure reference accuracy in scientific writing.
- Primary outcomes:
  - Facilitates operations for Citation Management.

## 2. Mission and Applicability
Use this module when you need to execute tasks related to Citation Management.

Apply when:
- Executing the legacy citation-management skill workflow.

Do not apply when:
- Functionality falls outside the scope of Comprehensive citation management for academic research. Search Google Scholar and PubMed for papers, extract accurate metadata, validate citations, and generate properly formatted BibTeX entries. This skill should be used when you need to find papers, verify citation information, convert DOIs to BibTeX, or ensure reference accuracy in scientific writing..
...
- [ ] Determine required inputs for citation-management.
