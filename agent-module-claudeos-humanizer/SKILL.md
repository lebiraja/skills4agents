---
name: agent-module-humanizer
description: "Module: Remove signs of AI-generated writing from text. Use when editing or reviewing
...
## 1. Module Metadata
- Module ID: `agent.module.humanizer`
- Version: `1.0.0`
- Maturity: `migrated`
- Scope: Remove signs of AI-generated writing from text. Use when editing or reviewing
text to make it sound more natural and human-written. Based on Wikipedia's
comprehensive "Signs of AI writing" guide. Detects and fixes patterns including:
inflated symbolism, promotional language, superficial -ing analyses, vague
attributions, em dash overuse, rule of three, AI vocabulary words, negative
...
- Primary outcomes:
  - Facilitates operations for Humanizer.

## 2. Mission and Applicability
Use this module when you need to execute tasks related to Humanizer.

Apply when:
- Executing the legacy humanizer skill workflow.

Do not apply when:
- Functionality falls outside the scope of Remove signs of AI-generated writing from text. Use when editing or reviewing
text to make it sound more natural and human-written. Based on Wikipedia's
comprehensive "Signs of AI writing" guide. Detects and fixes patterns including:
inflated symbolism, promotional language, superficial -ing analyses, vague
attributions, em dash overuse, rule of three, AI vocabulary words, negative
...
- [ ] Determine required inputs for humanizer.
